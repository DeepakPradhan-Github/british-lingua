                                            ...
                                            <div class="icon-img d-grid">
                                                ...
                                                <?php else: ?>
                                                    <?php if($enrolment['expiry_date'] == 0): ?>
                                                        ...
                                                        <span class="text-12px text-start mt-2"><?php echo get_phrase('You will be soon getting a call from our team (+91 9999107254) to discuss class timings and meeting link for the  classes.') ?></span>
