        ...
        <div class="form-group py-4">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <input class="form-control" type="text" value="<?php echo $sub_registered['enrollment_date']; ?>"
                        readonly>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="">Transaction Id</label>
                    <input class="form-control" type="text" value="<?php echo $sub_registered['transaction_id']; ?>"
                        readonly>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for=""> Student Name</label>
                    <input class="form-control" type="text" value="<?php echo $sub_registered['student_name']; ?>"
                        readonly>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="">Course Id</label>
                    <input class="form-control" type="text" value="<?php echo $sub_registered['course_id']; ?>"
                        readonly>
                </div>
