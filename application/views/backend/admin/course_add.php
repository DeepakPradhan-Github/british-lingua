                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <?php endif; ?>
                                                <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="level"><?php //echo get_phrase('level'); ?>Type</label>
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="web" id="level">
                                                        <option value=""><?php //echo get_phrase('beginner'); ?>Select Option</option>
                                                        <option value="0"><?php //echo get_phrase('advanced'); ?>Course</option>
                                                        <option value="1"><?php //echo get_phrase('intermediate'); ?>Webinar</option>
                                                        <option value="2"><?php //echo get_phrase('intermediate'); ?>Paid Demo</option>
                                                    </select>
                                                </div>
                                            </div>
                                                <div class="form-group row mb-3">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_title"><?php //echo get_phrase('course_title'); ?>Teacher<span class="required">*</span> </label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_title" name = "Teacher" placeholder="<?php //echo get_phrase('enter_course_title'); ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_title"><?php //echo get_phrase('course_title'); ?>Days <span class="required">*</span> </label>
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="course_title" name = "Days" placeholder="<?php //echo get_phrase('enter_course_title'); ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_title"><?php //echo get_phrase('course_title'); ?>Hours <span class="required">*</span> </label>
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="course_title" name = "Hourss" placeholder="<?php //echo get_phrase('enter_course_title'); ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
